    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent chooseEffectDynamic = new Intent(TestActivity.this, ChooseEffectDynamicActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if (requestCode == PHOTOREQUESTCODE.PHOTORESULT.toInt()){
            ...
            if (extras != null) {
                ...
                Intent chooseEffect = new Intent(TestActivity.this, ChooseEffectActivity.class);
